...
from deepencoder import build_qwen2_decoder_as_encoder
# from recurrent_deepencoder import build_qwen2_decoder_as_encoder
...
class DeepseekOCR2ForCausalLM(nn.Module, SupportsMultiModal, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # self.text_config = config.language_config
